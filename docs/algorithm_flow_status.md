...
flowchart TD
    ...
    J --> K["Simple accompaniment generation<br/>block chord, arpeggio, broken chord, pad"]
    K --> L["MIDI export<br/>Standard MIDI file bytes"]
    E --> L
    E --> M["MusicXML export<br/>single-part editable score"]
    H --> M
    ...
    class A1,C,D,E,F,G,H,I,J,K,L,X1,X2 done;
    class M partial;
...
- Simple MusicXML export: `include/music_elf/musicxml_writer.hpp`
- CLI demo: `tools/music_elf_cli.cpp`
- C ABI wrapper: `include/music_elf/c_api.h`
